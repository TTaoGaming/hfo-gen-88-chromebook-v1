...
# HFO HIVE8 GEN88 — Legendary Commanders 3+1 Compendium (V8.4, Portable, Full)
...
## Hyper Fractal Obsidian promotion bar (V8.4)
...
## Consistency + drift control (V8.4)
...
It is included to make V8.3 a single-file “full” reference while keeping machine-first YAML and the portability gates.

Note: V5 is a historical snapshot; some phrases inside it may use older shorthand (for example, legacy “8×8” language). V8.3 doctrine above supersedes those interpretations.
