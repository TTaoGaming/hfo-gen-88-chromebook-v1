...
consistency:
  superseded_by: v8.1
  canonical_path: hfo_hot_obsidian_forge/2_gold/2_resources/reports/hive8_doctrine/HFO_HIVE8_GEN88_V5_LEGENDARY_COMMANDERS_3_PLUS_1_COMPENDIUM_BLUF_PLUS_8x8_PLUS_META_V8_1_2026_01_29.md
...
Note: V5 is a historical snapshot; some phrases inside it may use older shorthand (for example, legacy “8×8” language). V8 doctrine above supersedes those interpretations.
