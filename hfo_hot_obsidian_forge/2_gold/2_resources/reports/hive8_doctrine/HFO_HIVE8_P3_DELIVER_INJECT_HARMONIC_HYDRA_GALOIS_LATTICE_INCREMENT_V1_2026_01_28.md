...
- **Anti-diagonal partner (sum-to-7)**: P4
...
- **Domain label (SSOT)**: Effect Delivery / Precision Strike (Injector) / Delivery / payload injection / recomposition
- **What the port produces**: Delivery payloads (events/commands), injections, controlled actuation
- **What the port rejects**: Side effects without guards, non-idempotent blasts, silent failures
