...
# HFO HIVE8 GEN88 — Legendary Commanders 3+1 Compendium (V8.2, Portable, Full)
...
## Consistency + drift control (V8.2)
...
It is included to make V8.2 a single-file “full” reference while keeping machine-first YAML and the portability gates.

Note: V5 is a historical snapshot; some phrases inside it may use older shorthand (for example, legacy “8×8” language). V8.2 doctrine above supersedes those interpretations.
