...
- **Anti-diagonal partner (sum-to-7)**: P3
- **Anti-diagonal stage**: 3 (P3 + P4)
...
- **Domain label (SSOT)**: Multi-Domain Operations / EW / Cyber (Disruptor) / Red team / contestation / destructive probing
- **What the port produces**: Feedback/suppression signals, disruption signatures, loop tuning
- **What the port rejects**: Runaway amplification, reward-hacking trajectories, noisy oscillations
