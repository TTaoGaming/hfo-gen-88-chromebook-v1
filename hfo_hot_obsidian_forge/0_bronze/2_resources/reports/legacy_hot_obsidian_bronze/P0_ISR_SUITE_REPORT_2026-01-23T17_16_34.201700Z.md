...
# P0 ISR Suite Report (Lidless Legion) — 2026-01-23T17_16_34.201700Z
...
[HFO HUB] P3 tracer: MCP server inventory
  ...
  optional_enabled: context7, omnisearch
[HFO HUB] P3 tracer: drift detected (optional/extra MCP servers enabled)
[HFO HUB] Set HFO_ALLOW_OPTIONAL_MCP=1 to allow >8 (not recommended).
