...
// Port boundary aliases for P5 Sentinel compliance
export const CloudEventEnvelopeSchema = HfoCloudEventSchema;
export const P0SensingSchema = CursorStateSchema;
export const P1PhysicsInputSchema = HandStateSchema;
