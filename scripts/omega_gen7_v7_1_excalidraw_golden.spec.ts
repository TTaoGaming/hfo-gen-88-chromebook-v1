...
const TARGET = '/hfo_hot_obsidian/bronze/1_projects/omega_gen7_current/app/omega_gen7_v7_1.html';

const FIXTURES_DIR = path.resolve(
    process.cwd(),
    'hfo_hot_obsidian/bronze/1_projects/omega_gen7_current/tests/fixtures/excalidraw',
);
