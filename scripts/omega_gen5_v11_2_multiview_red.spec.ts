...
test('Gen5 v11.2 RED: multiview uses single getUserMedia stream across multiple views', async ({ hfoPage }) => {
    ...
    // Expectations for v11.2 (will fail until implemented).
