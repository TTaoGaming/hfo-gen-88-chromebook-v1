...
test('Gen6 v17.3: tripwire lookahead knob pre-arms P3 and injects earlier than crossing', async ({ hfoPage }) => {
    ...
    // Key invariant: injection should occur before (or at) the actual crossing.
