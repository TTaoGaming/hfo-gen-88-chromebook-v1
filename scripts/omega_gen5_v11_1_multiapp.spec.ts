...
test('Gen5 v11.1 multiapp: AppHost activates sandbox + target router resolves inside active iframe', async ({ hfoPage }) => {
    const target = '/hfo_hot_obsidian/bronze/1_projects/omega_gen5_current/omega_gen5_v11_1.html';
    ...
    await hfoPage.waitForURL(/omega_gen5_v11_1\.html/i, { timeout: 20000 });
    ...
    if (!out.href || !out.href.match(/omega_gen5_v11_1\.html/i)) {
...
test('Gen5 v11.1 multiapp: GoldenLayout tab selection activates AppHost (sandbox)', async ({ hfoPage }) => {
    const target = '/hfo_hot_obsidian/bronze/1_projects/omega_gen5_current/omega_gen5_v11_1.html';
