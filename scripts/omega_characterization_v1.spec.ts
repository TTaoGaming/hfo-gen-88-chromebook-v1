...
const V21_URL = 'http://localhost:8888/hfo_hot_obsidian/bronze/2_areas/mission_thread_omega_gen_4/omega_gen4_v24_21.html';
const TELEMETRY_PATH = path.join(__dirname, '../test-results/golden_telemetry_v20.jsonl');

test.describe('Omega Characterization: v24.20 vs v24.21', () => {
    ...
    test('Phase 2: Replay Telemetry against v24.21 and Assert Parity', async ({ page }) => {
        ...
        console.log('✅ v24.21 passed Characterization against Golden Master v24.20');
    });
});
