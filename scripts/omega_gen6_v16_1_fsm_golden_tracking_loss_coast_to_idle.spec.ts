...
const GOLDEN_PATH =
    'hfo_hot_obsidian/bronze/3_resources/fixtures/fsm/gen6_v16_1_fsm_tracking_loss_coast_to_idle_golden.jsonl';

test('Gen6 v16.1 FSM golden: tracking loss drives COAST drain → IDLE; COMMIT only via READY', async ({ hfoPage }) => {
    const frames = fs
