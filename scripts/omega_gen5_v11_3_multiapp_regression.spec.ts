...
test('Gen5 v11.3 multiapp regression: AppHost activates sandbox + target router resolves inside active iframe', async ({ hfoPage }) => {
    ...
    if (!out.href || !out.href.match(/omega_gen5_v11_3\.html/i)) {
...
test('Gen5 v11.3 multiapp regression: GoldenLayout tab selection activates AppHost (sandbox)', async ({ hfoPage }) => {
    const target = '/hfo_hot_obsidian/bronze/1_projects/omega_gen5_current/omega_gen5_v11_3.html';
