...
import { V24GestureFSMState } from '../contracts/v24_gesture.zod';

export class GestureFSMV24 {
    private state: V24GestureFSMState;
    ...
    public process(gesture: string, timestamp: number): V24GestureFSMState {
    ...
    public getState(): V24GestureFSMState {
        return { ...this.state };
    }
}
