...
export const V25GestureFSMContract = CloudEventEnvelopeSchema.extend({
    type: z.literal('hfo.omega.v25.gesture_fsm'),
    data: z.object({
...
export type V25GestureFSMState = z.infer<typeof V25GestureFSMContract>;
