...
### 🧩 The Recursive Hourglass Pattern (HIVE/8:8787+)
HFO orchestration uses a **Double Diamond** pattern where each phase of the HIVE loop can spawn its own nested HIVE sub-loops.
