...
```mermaid
graph TD
    subgraph P0_Sense [P0: OBSERVER - 000]
        Kun[Kun Trigram: Earth]
    end
    subgraph P1_Fuse [P1: BRIDGER - 001]
        Gen[Gen Trigram: Mountain]
    end
    subgraph P2_Shape [P2: SHAPER - 010]
        Kan[Kan Trigram: Water]
    end
    subgraph P3_Inject [P3: INJECTOR - 011]
        Xun[Xun Trigram: Wind]
    end
    subgraph P4_Disrupt [P4: DISRUPTOR - 100]
        Zhen[Zhen Trigram: Thunder]
    end
    subgraph P5_Defend [P5: IMMUNIZER - 101]
        Li[Li Trigram: Fire]
    end
    subgraph P6_Store [P6: ASSIMILATOR - 110]
        Dui[Dui Trigram: Lake]
    end
    subgraph P7_Navigate [P7: NAVIGATOR - 111]
        Qian[Qian Trigram: Heaven]
    end

    P0_Sense -->|ISR Data| P1_Fuse
    P1_Fuse -->|Fabric Bridge| P2_Shape
    P2_Shape -->|Decision Matrix| P3_Inject
    P4_Disrupt <-->|Strange Loop| P5_Defend
    P0_Sense -.-> P6_Store
    P6_Store --> P7_Navigate
    P7_Navigate -->|Command Signal| P3_Inject
```
