...
# Daily Card — Version D (Top Table)

| Section | Why (1 line) | Example (1 line) |
|---|---|---|
| Areas | Coverage, low overload | work, health_admin, people_learning_play |
| Outcomes | Clear finish lines | ship outline; book appointment; read 10 pages |
| Actions | Reduce friction | open doc; send text; set timer |
| Anchor + MVP | Protect focus | 9:00–9:45 deep work; MVP=outline v1 |
| Gherkin | If‑then plan | Given 9am → When open doc → Then write 200 words |
| WOOP | Mental contrast | wish=finish; obstacle=phone; plan=phone away |
| Review | Fast reflection | work=4, health=3, people=4; win=outline done |
| GTD | Stage clarity | clarify; email client v1 |
