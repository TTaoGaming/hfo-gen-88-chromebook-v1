...
- **V71.1 Hot Bronze (2026-01-14)**: **OMEGA V24.1 STABILIZED**. Fixed critical regressions: `ReferenceError` in hero factory scoping, `TypeError` in null-engine resizing, and missing `ui-excalidraw` configuration. Verified via P5 Forensic PASS.
