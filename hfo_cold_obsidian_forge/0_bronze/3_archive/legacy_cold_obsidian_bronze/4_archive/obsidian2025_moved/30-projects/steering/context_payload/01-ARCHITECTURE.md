...
## Apex Assimilation Analysis (AoA/DSE)

Gen81 uses **Apex Assimilation Analysis** as the planning step before PDCA: a NASA-style **AoA/DSE** trade study (mission fit + TRL/maturity + Pareto frontier sets), explicitly treated as probabilistic.

- [Apex Assimilation Analysis note](07-APEX_ASSIMILATION_ANALYSIS.md)
