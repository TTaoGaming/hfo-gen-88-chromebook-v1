...
- **V84.2 Hot Bronze (2026-01-16)**: **OMEGA V36 INITIALIZED**. Decoupled the Overscan Architecture (UPE V3). Video and Babylon (Physical) now scale based on `zoomFactor`, while the Excalidraw Interface remains at 100% of the panel bounds to prevent toolbar clipping. Maintained 1:1 gesture parity via UPE projection. Added "Overscan Zoom" to Port 7 Navigator. [Receipt: SUCCESS_V36_DECOUPLED]
