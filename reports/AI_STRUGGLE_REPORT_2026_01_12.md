...
- **Result**: You get a file with a `Medallion: Gold` header that contains broken or stubbed `MediaPipe` code. This is **Adversarial ISR**—the system reports "Green" while the engine is stalling.
